...
import os
import dj_database_url  # Make sure to add dj-database-url to requirements.txt
...
STATIC_URL = '/static/'
STATIC_ROOT = BASE_DIR / 'staticfiles'  # Use 'staticfiles' for collected static files
...
# Optional security settings (strongly recommended for production)
if not DEBUG:
